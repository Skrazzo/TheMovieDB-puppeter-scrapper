...
$json = json_decode(file_get_contents($scrappedDir . '/' . $contents[$idx]), true);
...
<div class="container shadow rounded mt-5 p-2">
    ...
    <div class="d-flex gap-3 m-3">
        ...
        <div>
            ...
            <a href="<?= $json['tmdbURL'] ?>" target="_blank" rel="noopener noreferrer">TMDB</a>
        </div>
    </div>
    ...
    <table class="table table-striped">
        ...
        <?php 
        for($i = 0; $i < count($json['seasons']); $i++ ){
            ...
            <tr>
                ...
                <td>'. $season['year'] .'</td>
                <td style="max-width: 500px;">'. $season['overview'] .'</td>
            </tr>
            ';
        }
        ?>
